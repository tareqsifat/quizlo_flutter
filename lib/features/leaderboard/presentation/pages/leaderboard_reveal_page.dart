...
/// ─────────────────────────────────────────────
/// Leaderboard Reveal — Demo Mode only
/// A page in the post-quiz journey (Lesson Complete ->
/// Streak -> this), showing Demo User climbing the
/// weekly leaderboard. A fresh "before" and "after"
/// rank is picked at random every time it's shown;
/// the board starts at the before-rank, then animates
/// to the after-rank while the people in between
/// reflow around it.
/// ─────────────────────────────────────────────
class LeaderboardRevealPage extends StatefulWidget {
  final VoidCallback onContinue;

  const LeaderboardRevealPage({super.key, required this.onContinue});
...
class _LeaderboardRevealPageState extends State<LeaderboardRevealPage> {
  ...
  static final int _totalSlots = _otherNames.length + 1;

  late final int _initialRank;
  late final int _afterRank;
  late List<RankEntry> _standings;
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Text(
              _hasJumped ? 'You moved up!' : "This week's ranking",
